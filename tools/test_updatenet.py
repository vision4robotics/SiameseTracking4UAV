# Parts of this code come from https://github.com/zhanglichao/updatenet .
...
parser.add_argument('--snapshot', default='../experiments/UpdateNet/SiamRPNBIG.model', type=str,
                    help='snapshot of models to eval')
parser.add_argument('--update', default='../experiments/UpdateNet/vot2018.pth.tar', type=str,
                    help='update model')
parser.add_argument('--video', default='', type=str,
                    help='eval one special video')
parser.add_argument('--vis', default='', action='store_true',
                    help='whether visualzie result')
parser.add_argument('--trackername', default='UpdateNet', type=str,
...
def main():
    ...
    updatenet.load_state_dict(torch.load(args.update)['state_dict'])
    updatenet.eval().cuda()
        ...
        for v_idx, video in enumerate(dataset):
            ...
            for idx, (img, gt_bbox) in enumerate(video):
                ...
                if idx == 0:
                    ...
                    state = SiamRPN_track_upd(state, img, updatenet) 
