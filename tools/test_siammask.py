...
# Parts of this code come from https://github.com/foolwood/SiamMask and https://github.com/STVIR/pysot .
...
parser.add_argument('--config', default='../experiments/SiamMask/config.yaml', type=str,
                    help='config file')
parser.add_argument('--snapshot', default='../experiments/SiamMask/model.pth', type=str,
                    help='snapshot of models to eval')
parser.add_argument('--video', default='', type=str,
                    help='eval one special video')
parser.add_argument('--vis', default='', action='store_true',
                    help='whether visualzie result')
parser.add_argument('--trackername', default='SiamMask', type=str,
