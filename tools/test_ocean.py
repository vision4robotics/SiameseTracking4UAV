...
parser = argparse.ArgumentParser(description='ocean tracking')
...
parser.add_argument('--snapshot', default='../experiments/Ocean/model.pth', type=str,
                    help='pretrained model')
parser.add_argument('--align', default=False, type=bool, 
                    help='alignment module flag') 
...
parser.add_argument('--trackername', default='Ocean', type=str,
...
def main():
    # prepare model
    net = models.__dict__[args.arch](align=args.align, online=args.online)
    ...
    hp = {'Ocean':{'penalty_k': 0.08, 'lr': 0.305, 'window_influence': 0.44, 'small_sz': 127, 'big_sz': 287}}   # UAV123
